      ...
      <div className="max-w-sm w-full mx-auto h-[calc(100vh-84px)] min-h-[600px] flex flex-col opacity-0 animate-fadeIn">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-28">
          ...
          <p className="text-sm text-neutral-400 mt-2 text-center leading-6">
            Enter the email associated with your account. If there is an
            existing account with the provided email, we will send you an email
            with a special link to reset your password.
          </p>
          <input
            type="email"
            placeholder="Email"
