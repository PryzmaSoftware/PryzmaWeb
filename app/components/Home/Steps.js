    ...
    <div className="mt-20 p-4 opacity-0 animate-fadeIn" id="steps">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex mt-12">
          <div className="p-[2px] bg-gradient-to-br rounded-md from-cyan-600 to-rose-600 w-full mr-6 flex justify-center items-center">
          ...
          <div className="p-[2px] bg-gradient-to-br from-emerald-600 to-fuchsia-600 rounded-md w-full mr-6 flex justify-center items-center">
            <div className="p-3 py-6 rounded-md w-full bg-black h-full">
              <p className="font-medium text-2xl text-white text-center">
                Research
              </p>
