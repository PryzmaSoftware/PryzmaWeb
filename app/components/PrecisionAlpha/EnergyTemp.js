  ...
  return (
    <div className="w-full">
      <p className="text-xl text-white font-medium">
        Market Free Energy & Temperature
      </p>
      <p className="text-sm text-neutral-400 mb-6">
        The energy available to do useful price movement work. As the free
        energy drops, the price and temperature will move up (direction of
        dominant probability) over an extended number of days and weeks while
        things heat up.
      </p>
